<template>
  <ion-page>
    <ion-content :fullscreen="true">
      <section
        class="pt-10 bg-gray-50 dark:bg-gray-900 h-full bg-[url('@/assets/img/bg.png')] bg-no-repeat bg-cover bg-center backdrop-blur">
        <div class="h-full backdrop-blur-sm">
          <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
              <img class="mr-2" width="200" src="@/assets/img/logo-color.png" alt="logo">
            </a>
            <div
              ...
              <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="#">
                  ...
                  <div>
                    ...
                    <div class="relative mb-6">
                      <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                        <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100"
                          viewBox="0 0 50 50">
                          <path
                  ...
                  <div class="flex items-center justify-between">
                    <div class="flex items-start">
                      ...
                      <div class="ml-3 text-sm">
                        <label for="remember" class="text-gray-500 dark:text-gray-300">Recordar mis datos</label>
                      </div>
                    </div>
                    <a href="#"
                  ...
                  <button type="button" @click="signIn()"
                    class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Ingresar</button>
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                    ¿No tienes una cuenta? <router-link :to="{ name: 'register' }"
                      class="font-medium text-primary-600 hover:underline dark:text-primary-500">Registrarte</router-link>
                  </p>
                </form>
              </div>
            </div>
